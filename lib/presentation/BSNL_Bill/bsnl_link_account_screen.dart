...
import 'package:scspay/presentation/BSNL_Bill/account_review_screen.dart';
...
class BSNLLinkAccountScreen extends StatefulWidget {
  const BSNLLinkAccountScreen({Key? key}) : super(key: key);

  @override
  State<BSNLLinkAccountScreen> createState() => _BSNLLinkAccountScreenState();
}

class _BSNLLinkAccountScreenState extends State<BSNLLinkAccountScreen> {
  @override
      ...
      body: Stack(
        ...
        children: [
          ...
          GestureDetector(
            onDoubleTap: (){},
            onTap: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>AccountReviewScreen()));
            },
            child: Container(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                Padding(
                  padding: EdgeInsets.only(left: parentWidth*0.05, right: parentWidth*0.05, top: parentHeight*0.01),
                  child: TextFormField(
                ...
                Padding(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                      Text("Please Enter Your Landline Number with STD Code (without 0)",
                        style: TextStyle(
