...
class BSNLBillScreen extends StatefulWidget {

  const BSNLBillScreen({Key? key}) : super(key: key);

  @override
  State<BSNLBillScreen> createState() => _BSNLBillScreenState();
}

class _BSNLBillScreenState extends State<BSNLBillScreen> {
  @override
