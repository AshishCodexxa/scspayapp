...
import 'package:scspay/presentation/fastag_vehicle_already_pesent_screen.dart';
import 'package:scspay/presentation/perticular_bank_fastag.dart';




class FasTagBankList extends StatefulWidget {
  const FasTagBankList({Key? key}) : super(key: key);

  @override
  State<FasTagBankList> createState() => _FasTagBankListState();
}

class _FasTagBankListState extends State<FasTagBankList> {
              ...
              child: Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        hintText: focusText == true ? "" : "Type your FASTag Provider Name",
                        hintStyle: TextStyle(
                            color: Colors.black26,
                            fontFamily: 'Roboto_Regular',
                            fontWeight: FontWeight.w400,
