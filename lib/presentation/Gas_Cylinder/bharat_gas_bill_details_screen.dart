...
import '../../all_dialog/gas_bill_pay_dialog.dart';



class BharatGasBillDetailScreen extends StatefulWidget {
  const BharatGasBillDetailScreen({Key? key}) : super(key: key);

  @override
  State<BharatGasBillDetailScreen> createState() => _BharatGasBillDetailScreenState();
}

class _BharatGasBillDetailScreenState extends State<BharatGasBillDetailScreen> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(top: parentHeight*0.02, right: parentWidth*0.01),
                child: Container(
                  color: Colors.transparent,
