...
class GasBookingWithLPGScreen extends StatefulWidget {
  const GasBookingWithLPGScreen({Key? key}) : super(key: key);

  @override
  State<GasBookingWithLPGScreen> createState() => _GasBookingWithLPGScreenState();
}

class _GasBookingWithLPGScreenState extends State<GasBookingWithLPGScreen> {
      ...
      body: Stack(
        ...
        children: [
          ...
          GestureDetector(
            onDoubleTap: (){},
            onTap: (){
             Navigator.push(context, MaterialPageRoute(builder: (context)=>BharatGasBillDetailScreen()));
            },
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsets.only(left: parentWidth*0.0, right: parentWidth*0.03, top: parentHeight*0.01),
                        child: TextFormField(
                      ...
                      Padding(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.start,
                          children: [
                            Text("Please Enter Valid 17 Digit LPG ID",
                              style: TextStyle(
