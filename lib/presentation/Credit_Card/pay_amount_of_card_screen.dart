...
class CardAmountAddScreen extends StatefulWidget {

  const CardAmountAddScreen({Key? key}) : super(key: key);

  @override
  State<CardAmountAddScreen> createState() => _CardAmountAddScreenState();
}

class _CardAmountAddScreenState extends State<CardAmountAddScreen> {
  @override
                                 ...
                                 Expanded(
                                   child: TextFormField(
                                    decoration: InputDecoration(
                                      contentPadding: EdgeInsets.only(left: parentWidth*0.01),
