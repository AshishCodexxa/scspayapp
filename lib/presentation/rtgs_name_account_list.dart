...
class RTGSNameAccountList extends StatefulWidget {
  const RTGSNameAccountList({Key? key}) : super(key: key);

  @override
  State<RTGSNameAccountList> createState() => _RTGSNameAccountListState();
}

class _RTGSNameAccountListState extends State<RTGSNameAccountList> {
  @override
