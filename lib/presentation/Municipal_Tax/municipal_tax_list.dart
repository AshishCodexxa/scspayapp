...
import 'package:scspay/presentation/Municipal_Tax/municipal_customer_id_screen.dart';



class MunicipalListScreen extends StatefulWidget {
  const MunicipalListScreen({Key? key}) : super(key: key);

  @override
  State<MunicipalListScreen> createState() => _MunicipalListScreenState();
}

class _MunicipalListScreenState extends State<MunicipalListScreen> {
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: GestureDetector(
                                      onDoubleTap: (){},
                                      onTap: (){
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=>MunicipalCustomerIdScreen()));
                                      },
                                      child: Container(
                                        color: Colors.transparent,
                                        child: Row(
              ...
              child: Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        hintText: focusText == true ? "" : "Search by Provider",
                        hintStyle: TextStyle(
                            color: Colors.black26,
                            fontFamily: 'Roboto_Regular',
                            fontWeight: FontWeight.w400,
