...
class MunicipalTaxBillScreen extends StatefulWidget {

  const MunicipalTaxBillScreen({Key? key}) : super(key: key);

  @override
  State<MunicipalTaxBillScreen> createState() => _MunicipalTaxBillScreenState();
}

class _MunicipalTaxBillScreenState extends State<MunicipalTaxBillScreen> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(top: parentHeight*0.01, right: parentWidth*0.0),
                child: Container(
                  color: Colors.transparent,
                  width: parentWidth*0.9,
                  child: Row(
