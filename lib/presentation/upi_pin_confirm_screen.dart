...
class _UpiPinConfirmScreenState extends State<UpiPinConfirmScreen> {
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Image(image: AssetImage("assets/images/upi_pin_image.png")),
            ],
          ),
          ...
          Padding(
            padding: EdgeInsets.only(top: parentHeight*0.07, left: parentWidth*0.15, right: parentWidth*0.15),
            child: Container(
              color: Colors.transparent,
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
