...
class MSEDCMahaVitaranBillScreen extends StatefulWidget {

  final String isComeFrom;

  const MSEDCMahaVitaranBillScreen({Key? key, required this.isComeFrom}) : super(key: key);

  @override
  State<MSEDCMahaVitaranBillScreen> createState() => _MSEDCMahaVitaranBillScreenState();
}

class _MSEDCMahaVitaranBillScreenState extends State<MSEDCMahaVitaranBillScreen> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Visibility(
                visible: widget.isComeFrom == "2" ? true : false,
                child: Padding(
                  padding: EdgeInsets.only(top: parentHeight*0.02, right: parentWidth*0.0),
                  child: Container(
                    color: Colors.transparent,
