...
import 'package:scspay/all_dialog/electricity_option_dialog.dart';
...
import 'package:scspay/presentation/ElectricityBill/select_ectricity_account_id_screen.dart';



class ElectricityBillListScreen extends StatefulWidget {
  const ElectricityBillListScreen({Key? key}) : super(key: key);

  @override
  State<ElectricityBillListScreen> createState() => _ElectricityBillListScreenState();
}

class _ElectricityBillListScreenState extends State<ElectricityBillListScreen> {
                    ...
                    [
                      Padding(
                        ...
                        child: GestureDetector(
                          onDoubleTap: (){},
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>MSEDCMahaVitaranBillScreen(isComeFrom: '2',)));
                          },
                          child: Container(
                ...
                children: [
                  Padding(
                    ...
                    child: GestureDetector(
                      onDoubleTap: (){},
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>ElectricityAccountIdScreen()));
                      },
                      child: Container(
                        color: Colors.transparent,
                        child: Row(
