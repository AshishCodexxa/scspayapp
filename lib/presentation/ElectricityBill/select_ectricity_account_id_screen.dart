...
class ElectricityAccountIdScreen extends StatefulWidget {
  const ElectricityAccountIdScreen({Key? key}) : super(key: key);

  @override
  State<ElectricityAccountIdScreen> createState() => _ElectricityAccountIdScreenState();
}

class _ElectricityAccountIdScreenState extends State<ElectricityAccountIdScreen> {
  @override
      ...
      body: Stack(
        ...
        children: [
          ...
          GestureDetector(
            onDoubleTap: (){},
            onTap: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>MSEDCMahavitaranScreen()));
            },
            child: Container(
        ...
        children: [
          ...
          Padding(
            ...
            child: Container(
              ...
              child: Text("Adani Electricity Mumbai Limited",
                style: TextStyle(
