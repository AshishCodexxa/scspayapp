...
class PostpaidMobileNumberScreen extends StatefulWidget {
  const PostpaidMobileNumberScreen({Key? key}) : super(key: key);

  @override
  State<PostpaidMobileNumberScreen> createState() => _PostpaidMobileNumberScreen();
}

class _PostpaidMobileNumberScreen extends State<PostpaidMobileNumberScreen> {
