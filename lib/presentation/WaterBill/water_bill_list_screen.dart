...
class WaterBillListScreen extends StatefulWidget {
  const WaterBillListScreen({Key? key}) : super(key: key);

  @override
  State<WaterBillListScreen> createState() => _WaterBillListScreenState();
}

class _WaterBillListScreenState extends State<WaterBillListScreen> {
              ...
              slivers: <Widget>[
                SliverList(
                  delegate: SliverChildListDelegate(
                    [
                      getAllFasTagList(SizeConfig.screenHeight, SizeConfig.screenWidth)
                    ],
                  ),
                ),
              ],
                  ...
                  children: [
                    Padding(
                      ...
                      child: GestureDetector(
                        onDoubleTap: (){},
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>WaterBillCustomerNoScreen()));
                        },
                        child: Container(
                          color: Colors.transparent,
                          child: Row(
