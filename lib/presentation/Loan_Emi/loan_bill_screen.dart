...
class LoanBillScreen extends StatefulWidget {

  const LoanBillScreen({Key? key}) : super(key: key);

  @override
  State<LoanBillScreen> createState() => _LoanBillScreenState();
}

class _LoanBillScreenState extends State<LoanBillScreen> {
  @override
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      color: Colors.transparent,
                      child: Text(
                          "Two Thousand Two Hundred Ninety Four Rupees  Only",
                          style: TextStyle(
                              fontSize:
                              SizeConfig.blockSizeHorizontal * 4.0,
                              fontWeight: FontWeight.w500,
